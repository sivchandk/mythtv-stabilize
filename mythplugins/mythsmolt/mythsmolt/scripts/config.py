...
HW_UUID = home + "/.mythtv/MythSmolt/hw-uuid"
PUB_UUID= home +  "/.mythtv/MythSmolt/pub-uuid"
UUID_DB = home + '/.mythtv/MythSmolt/uuiddb.cfg'
ADMIN_TOKEN = home +  "/.mythtv/MythSmolt/smolt_token"
